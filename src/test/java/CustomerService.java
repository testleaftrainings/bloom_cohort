...
//        driver.findElement(By.id("password")).sendKeys("Leaf$321");
    ...
    public void testShadowRoot() throws InterruptedException {
        ...
        WebElement learnMore = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[@title='Learn More']")));
       ...
       shadow.highlight(Products);
        ...
        List<WebElement> elements = shadow.findElementsByXPath("//a[contains(text(),'See all service solutions')]/../../ul/li/div/a");
        System.out.println(elements.size());
        elements.forEach(e-> System.out.println(e.getText().trim()));

        /*List<String> stringList = shadow.findElementByXPath("//div/span[text()='Service']/../../../..//*[contains(name(),'panellinkedlist')]").getShadowRoot().findElements(By.cssSelector("div > ul > li > div > a"))
                .stream().map(e -> e.getText()).collect(Collectors.toList());*/



         //a[contains(text(),'See all service solutions')]/../../ul.li/div/a
